...
export default function ChatPage() {
  ...
  return (
    <div className="flex items-center justify-center min-h-screen p-3">
      <div className="w-full max-w-2xl h-[80vh] flex flex-col bg-gray-900 rounded-lg shadow-2xl bg-opacity-80 overflow-hidden z-20 border border-gray-700 md:mb-0">
